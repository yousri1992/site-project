...
if (isset($_GET['id_demande']) && isset($_SESSION['ID_entreprise'])) {
    ...
    if (isset($_GET['confirm']) && $_GET['confirm'] === 'true') {
        ...
        if ($connection->connect_error) {
            ...
            // Préparer la requête pour mettre à jour l'état de la demande
$sql_update = "UPDATE tab_demande SET etat_demande = 2 WHERE id_demande = ?";
...
if ($stmt) {
    ...
    echo "Erreur lors de la préparation de la requête.";
        ...
        if (confirmed) {
            window.location.href = '/GLT/pageAnuler.php?id_demande=$id_demande&confirm=true';
        } else {
